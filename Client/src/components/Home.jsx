    ...
    return (
        ...
        ">
            ...
            ">
                ...
                leading-none
                tracking-tighter
              "> Fake Drug Detection Tool </h1>
                            <p class="mb-8 text-base leading-relaxed text-left text-gray-500">A Blockchain based application for detecting Counterfeited Drugs in the B2C and B2B supply chain which will benefit businesses in terms of growth, reputation, trust and to customers in getting genuine Drugs in hand.</p>
                  ...
                  ">
                      ...
                      tracking-tighter
                    "> Detect Drug </h2>
                                        <p class="text-base leading-relaxed text-gray-400">Check about the current owner and history of owners of the Drug.</p>
